...
public class PharmacyModel {
  ...
  private SimpleObjectProperty<Product> trenutni=new SimpleObjectProperty<>();
    ...
    public void napuni(){
        products.add(new Product("Paracetamol","1","Tablete","2 KM","7"));
        products.add(new Product("Flonidan","2","Tablete","2 KM","11"));
        products.add(new Product("Analgin","3","Tablete","2 KM","15"));
    }
}
